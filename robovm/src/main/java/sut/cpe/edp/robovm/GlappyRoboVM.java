...
public class GlappyRoboVM extends UIApplicationDelegateAdapter {

  @Override
  public boolean didFinishLaunching (UIApplication app, UIApplicationLaunchOptions launchOpts) {
    // create a full-screens window
  ...
  public static void main (String[] args) {
    ...
    UIApplication.main(args, null, GlappyRoboVM.class);
    pool.close();
  }
}
